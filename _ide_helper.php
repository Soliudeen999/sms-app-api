...
namespace Illuminate\Support\Facades {
    ...
    class Http {
        ...
        /**
         * @see \App\Utils\Macros\HttpMacro::AuthAppApiCall()
         * @return \Illuminate\Http\Client\PendingRequest
         * @static
         */
        public static function dotgo()
        {
            return \Illuminate\Http\Client\Factory::dotgo();
        }
         ...
         * @static
         */
        public static function africaIsTalking($headers = [])
        {
            return \Illuminate\Http\Client\Factory::africaIsTalking($headers);
        }
         ...
         * @static
         */
        public static function t2fromcoms($headers = [])
        {
            return \Illuminate\Http\Client\Factory::t2fromcoms($headers);
        }
    ...
    class Response {
        ...
        /**
         * @see \App\Utils\Macros\ResponseMacro::facadeSuccess()
         ...
         * @static
         */
        public static function success($data = null, $message = 'Request Completed', $http_code = 200, $headers = [])
        {
            return \Illuminate\Routing\ResponseFactory::success($data, $message, $http_code, $headers);
        }

        /**
         * @see \App\Utils\Macros\ResponseMacro::facadeError()
         * @param object|array|null $data
         * @param string $message
         * @param int $http_code
         * @param array $headers
         * @static
         */
        public static function error($data = null, $message = 'Error Occurred', $http_code = 400, $headers = [])
        {
            return \Illuminate\Routing\ResponseFactory::error($data, $message, $http_code, $headers);
        }
...
namespace Akaunting\Setting {
    /**
     */
    class Facade extends \Akaunting\Setting\Contracts\Driver {
        /**
...
namespace Illuminate\Http {
    ...
    class Response extends \Symfony\Component\HttpFoundation\Response {
        /**
         * @see \App\Utils\Macros\ResponseMacro::success()
         * @param object|array|null $data
         * @param string $message
         * @param int $http_code
         * @param array $headers
        ...
        public static function success($data = null, $message = 'Request Completed', $http_code = 200, $headers = [])
        {
            return \Illuminate\Http\Response::success($data, $message, $http_code, $headers);
        }

        /**
         * @see \App\Utils\Macros\ResponseMacro::noContent()
         * @param object|array|null $data
         * @param string $message
         * @param int $http_code
         * @param array $headers
         * @static
         */
        public static function noContent($data = null, $message = 'Request Completed', $http_code = 204, $headers = [])
        {
            return \Illuminate\Http\Response::noContent($data, $message, $http_code, $headers);
        }

        /**
         * @see \App\Utils\Macros\ResponseMacro::error()
         * @param object|array|null $data
         * @param string $message
         * @param int $http_code
         * @param array $headers
        ...
        public static function error($data = null, $message = 'Error Occurred', $http_code = 400, $headers = [])
        {
            return \Illuminate\Http\Response::error($data, $message, $http_code, $headers);
        }

        /**
         * @see \App\Utils\Macros\ResponseMacro::validationError()
         * @param object|array|null $error
         * @param string $message
         * @param int $http_code
         * @param array $headers
         * @static
         */
        public static function validationError($error = null, $message = 'Please check your input and try again.', $http_code = 422, $headers = [])
        {
            return \Illuminate\Http\Response::validationError($error, $message, $http_code, $headers);
        }
...
namespace BenSampo\Enum {
    ...
    class Enum {
        /**
         * @see \App\Utils\Macros\GeneralMacros::getAsSeparatedString()
         * @param string $separator
         * @static
         */
        public static function getAsSeparatedString($separator = ',')
        {
            return \BenSampo\Enum\Enum::getAsSeparatedString($separator);
        }
